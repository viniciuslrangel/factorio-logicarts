...
-- Since cars don't start miving until the path is free, this should be close to
...
-- If CAR_TICK_ARRIVING is accurate enough this won't be used...
local CAR_TICK_ARRIVING = math.max(1, math.ceil(1/CAR_ENTITY_SPEED/60))

-- Tick delay between updates when a car is blocked (off path, crashed, blocked by another car)
